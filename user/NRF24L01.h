...
//NRF2401接收片选信号
#define Clr_NRF24L01_RX_CE      HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_RX_CE      HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_SET)

//SPI片选信号	
#define Clr_NRF24L01_RX_CSN     HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_RX_CSN     HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_SET)
    
//NRF2401_IRQ数据输入
#define Clr_NRF24L01_RX_IRQ     HAL_GPIO_WritePin(IRQ_GPIO_Port, IRQ_Pin, GPIO_PIN_RESET) 
#define Set_NRF24L01_RX_IRQ     HAL_GPIO_WritePin(IRQ_GPIO_Port, IRQ_Pin, GPIO_PIN_SET) 

#define READ_NRF24L01_RX_IRQ    HAL_GPIO_ReadPin(IRQ_GPIO_Port, IRQ_Pin) 


//NRF2401发射片选信号
#define Clr_NRF24L01_TX_CE      HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_TX_CE      HAL_GPIO_WritePin(CE_GPIO_Port, CE_Pin, GPIO_PIN_SET)

//SPI片选信号	
#define Clr_NRF24L01_TX_CSN     HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_TX_CSN     HAL_GPIO_WritePin(CSN_GPIO_Port, CSN_Pin, GPIO_PIN_SET)
    
//NRF2401_IRQ数据输入
#define Clr_NRF24L01_TX_IRQ     HAL_GPIO_WritePin(IRQ_GPIO_Port, IRQ_Pin, GPIO_PIN_RESET) 
#define Set_NRF24L01_TX_IRQ     HAL_GPIO_WritePin(IRQ_GPIO_Port, IRQ_Pin, GPIO_PIN_SET) 

#define READ_NRF24L01_TX_IRQ    HAL_GPIO_ReadPin(IRQ_GPIO_Port, IRQ_Pin) 
